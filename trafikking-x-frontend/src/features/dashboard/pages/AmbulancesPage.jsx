    ...
    return (
      ...
      <div className="rounded-3xl border bg-card/40 p-12">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <Ambulance className="mb-5 h-10 w-10 animate-pulse text-primary" />
          ...
          <p className="mt-2 text-muted-foreground">
            ...
            Fetching registered ambulance units.
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              Monitor registered ambulance units,
              fleet status and emergency response readiness.
